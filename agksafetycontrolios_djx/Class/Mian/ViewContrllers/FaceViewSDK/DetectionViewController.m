...
-(void)setOutStatu:(showCodeTimeOutStatu)outStatu{
    _outStatu = outStatu;
}
...
//                            [weakSelf closeAction];
            ...
            case DetectRemindCodeTimeout: {
                if (self.outStatu ==  showCodeTimeOutStartStatu) {
                    dispatch_async(dispatch_get_main_queue(), ^{
