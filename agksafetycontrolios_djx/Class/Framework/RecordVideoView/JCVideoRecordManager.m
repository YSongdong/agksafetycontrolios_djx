...
static const CGFloat KMaxRecordTime = 20;    //最大录制时间
...
+ (NSString*)cacheFilePath:(BOOL)input{
    ...
    NSString *fileName = [NSString stringWithFormat:@"%@_%@.%@",timeStr,put,path];
...
+ (NSString *) getCacheDirWithCreate:(BOOL)isCreate {
    ...
    dir = [dir stringByAppendingPathComponent:@"RecordVideo"];
    dir = [dir stringByAppendingPathComponent:@"video"];
